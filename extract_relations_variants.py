...
entities_file_path = "./data/mcq/variants.data"
context_file_path = "./data/context_of_disease_which_has_relation_to_genes.csv"
extracted_entity_log_path = "./data/extracted_variants_entity.log"
extracted_context_log_path = "./data/extracted_variants_context.log"
